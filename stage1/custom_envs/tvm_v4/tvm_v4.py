from custom_envs.tvm_v4.tvm_v4_in import *
...
class TVM(gym.Env):
    ...
    def __init__(self, render_mode=None) -> None:
        ...
        self.observation_space=gym.spaces.Box(low=np.array([0,-5,0,0]*3+[0,0]),high=np.array([10,5,1,1]*3+[3,3]),shape=(14,),dtype=np.float32)
